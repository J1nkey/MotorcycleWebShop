...
namespace MotorcycleWebShop.Application.Posts.Queries.GetBriefPost
{
    ...
    public class GetBrieftPostQueryHandler : IRequestHandler<GetBriefPostQuery, PaginatedList<BriefPostDto>>
    {
        private readonly IApplicationDbContext _db;
        private readonly IMapper _mapper;

        public GetBrieftPostQueryHandler(IApplicationDbContext db,
            IMapper mapper)
        {
            _db = db;
            _mapper = mapper;
